...
?>    
				<aside id="sidebar-3" class="sidebars" role="complementary">
					...
					<h1 class="visuallyhidden section-title"><?php _e('Aside Sidebar 3', 'basics' ); ?></h1>
					
				<?php if ( is_active_sidebar( 'war-9' ) ) : ?>
					<section id="widget-area-9" class="widget">
						<h2 class="visuallyhidden section-title"><?php _e('Section widget area 9', 'basics' ); ?></h2>
						<?php dynamic_sidebar( 'war-9' ); ?>
					</section> <!-- eo #widget-area-9 .widget -->
				<?php endif; ?>

					<section id="widget-area-10" class="widget">
						<h2 class="visuallyhidden section-title"><?php _e('Section widget area 10', 'basics' ); ?></h2>
				<?php if ( ! dynamic_sidebar( 'war-10' ) ) : ?>
						<div id="basics-categories">
							<h3><?php _e( 'Categories', 'basics' ) ; ?></h3>
							<?php $args = array(
